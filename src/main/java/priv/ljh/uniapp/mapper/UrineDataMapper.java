...
public interface UrineDataMapper extends BaseMapper<UrineData> {
     ...
     * @return
     */
    @Insert(" insert into urine_data (patient_data_id) select id  from patient_data")
    int insertUrine();
     ...
     * @return
     */
    @Select("select id, patient_data_id, leu, nit, pro, glu_u, ket, uro, bil, ph_u, sg, blu, vc, col, tmd, tsxb, u_wbc_c, klgx_f, u_tm_ca, u_rbc_, lygx, wbc_j1, wbc_j2, note from urine_data where id = #{id}")
